...
final class MySQL
{
	...
	public static function getInstance($connect = true, $database = null, $server = null,
	                            $username = null, $password = null, $charset = null,
	                            $collation = null) {
		if (self::$oInstance==false) {
			self::$oInstance=new MySQL($connect, $database, $server,$username, $password, $charset,$collation);
		}
	 ...
	 * $db = new MySQL(true, "database", "localhost", "username", "password");
	 */
	private function __construct($connect = true, $database = null, $server = null,
	                            $username = null, $password = null, $charset = null,
	                            $collation = null)
	{
	                               ...
	                               $sortColumns = null, $limit = null)
	{
		...
		$sql = 'SELECT ' . $sql . ' FROM ' . self::SQLFixName($tableName);
		if (!is_null($whereArray))
		{
			$wh = $this->BuildSQLWhereClause($whereArray);
			if (!is_string($wh)) return false;
	...
	public function TimerDurationSeconds() {
		return ($this->time_diff>0 ? $this->time_diff/1000 : 0); 
	}
