 ...
 */
function purl_init($url = null) {    
    $ch = new \RLDL\Curl\Purl();
 ...
 */
function curl_copy_handle(\RLDL\Curl\Purl $ch) {
    return clone $ch; 
}
 ...
 */
function curl_setopt(\RLDL\Curl\Purl $ch, $option, $value) {
 ...
 */
function curl_setopt_array(\RLDL\Curl\Purl $ch , array $options) {
 ...
 * occurred.
 */
function curl_errno(\RLDL\Curl\Purl $ch) {
 ...
 * error occurred.
 */
function curl_error(\RLDL\Curl\Purl $ch) {
    return $ch->getError();
}
 ...
 */
function curl_close(\RLDL\Curl\Purl &$ch) {
    unset($ch);
}
 ...
 */
function curl_exec(\RLDL\Curl\Purl $ch) {
    return $ch->execute();
}
 ...
 */
function curl_getinfo(\RLDL\Curl\Purl $ch, $opt = 0) {
